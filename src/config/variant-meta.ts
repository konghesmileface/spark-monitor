...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  spark: {
    title: 'Spark Monitor - Global Intelligence for Finance Professionals',
    description: 'Real-time global intelligence dashboard tailored for finance professionals. Live geopolitical news, markets, commodities, infrastructure monitoring, and risk analytics.',
    keywords: 'spark finance, global intelligence, geopolitical risk, market data, commodities, AIS shipping, conflict zones, infrastructure monitoring, bond market, fixed income, financial intelligence',
    url: 'https://spark.worldmonitor.app/',
    siteName: 'Spark Monitor',
    shortName: 'SparkMonitor',
    subject: 'Global Intelligence for Finance Professionals',
    classification: 'Financial Intelligence Dashboard, Geopolitical Risk Monitor',
