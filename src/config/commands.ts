...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:regional-intel', keywords: ['middle east', 'africa', 'latin america', 'asia', 'energy', 'government', 'think tanks', 'regional'], label: 'Panel: Regional Intel', icon: '\u{1F30D}', category: 'panels' },
